...
``` sh
storm jar target/es-stormcrawler-1.0-SNAPSHOT.jar com.tiagoramalho.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/es-stormcrawler-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
